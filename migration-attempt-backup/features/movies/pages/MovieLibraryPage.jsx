// src/pages/movies/MovieLibraryPage.jsx â€” Fixed Version
...
export default function MovieLibraryPage() {
  ...
  const fetchMovies = useCallback(async () => {
    ...
    try {
      ...
      setError('áž˜áž·áž“áž¢áž¶áž…áž‘áž¶áž‰áž™áž€áž‘áž·áž“áŸ’áž“áž“áŸáž™áž”áž¶áž“áž‘áŸáŸ”');
      setMovies([]);
      setTotalCount(0);
    } finally {
      setLoading(false);
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400">
              {loading ? (
                ...
                <>
                  áž”áž¶áž“ážšáž€ážƒáž¾áž‰ <span className="text-white font-bold">{totalCount.toLocaleString()}</span> ážšáž¿áž„
                </>
              )}
            </p>
          </div>
          ...
          <div className="bg-card rounded-xl p-4 mb-8 sticky top-20 z-30 backdrop-blur-sm bg-opacity-95 border border-white/5 shadow-lg">
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <form onSubmit={handleSearch} className="flex-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="ážŸáŸ’ážœáŸ‚áž„ážšáž€áž—áž¶áž–áž™áž“áŸ’áž..."
              ...
              >
                <option value="-release_date">ážáŸ’áž˜áž¸áž”áŸ†áž•áž»áž</option>
                <option value="-view_count">áž–áŸáž‰áž“áž·áž™áž˜áž”áŸ†áž•áž»áž</option>
                <option value="-rating">áž–áž·áž“áŸ’áž‘áž»ážáŸ’áž–ážŸáŸ‹</option>
                <option value="title">ážˆáŸ’áž˜áŸ„áŸ‡ (A-Z)</option>
              </select>
            ...
            {hasActiveFilters && (
              <div className="mt-3 flex items-center gap-2">
                <span className="text-xs text-gray-500">ážáž˜áŸ’ážšáž„ážŸáž€áž˜áŸ’áž˜áŸ–</span>
                <button
                  onClick={handleClearFilters}
                  className="text-xs text-red-400 hover:text-red-300 flex items-center gap-1"
                >
                  <i className="bi bi-x-circle"></i>
                  ážŸáž˜áŸ’áž¢áž¶ážáž‘áž¶áŸ†áž„áž¢ážŸáŸ‹
                </button>
              </div>
            )}
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              >
                áž–áŸ’áž™áž¶áž™áž¶áž˜áž˜áŸ’ážáž„áž‘áŸ€áž
              </button>
            </div>
          ) : movies.length === 0 ? (
            // Empty State
            <div className="text-center py-20">
              ...
              <p className="text-gray-400 text-lg mb-2">ážšáž€áž˜áž·áž“ážƒáž¾áž‰áž—áž¶áž–áž™áž“áŸ’ážáž‘áŸ</p>
              <p className="text-gray-500 text-sm mb-6">ážŸáž¶áž€áž›áŸ’áž”áž„áž•áŸ’áž›áž¶ážŸáŸ‹áž”áŸ’ážáž¼ážšážáž˜áŸ’ážšáž„ áž¬áž–áž¶áž€áŸ’áž™ážŸáŸ’ážœáŸ‚áž„ážšáž€</p>
              <button
                onClick={handleClearFilters}
                className="text-red-500 hover:text-red-400 transition flex items-center gap-2 mx-auto"
              >
                <i className="bi bi-arrow-repeat"></i>
                ážŸáž˜áŸ’áž¢áž¶ážážáž˜áŸ’ážšáž„
              </button>
            </div>
          ) : viewMode === 'grid' ? (
            // Grid View
