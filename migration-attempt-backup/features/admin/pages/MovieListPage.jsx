...
import Badge, { accessTone, statusTone } from "../../components/ui/Badge";
...
export default function MovieListPage() {
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("áž›áž»áž”áž—áž¶áž–áž™áž“áŸ’ážáž“áŸáŸ‡? ážŸáž€áž˜áŸ’áž˜áž—áž¶áž–áž“áŸáŸ‡áž˜áž·áž“áž¢áž¶áž…ážáŸ’ážšáž¡áž”áŸ‹ážœáž·áž‰áž”áž¶áž“áž‘áŸáŸ”")) return;
    try {
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-slate-400 text-sm">áž€áŸ†áž–áž»áž„áž•áŸ’áž‘áž»áž€áž‘áž·áž“áŸ’áž“áž“áŸáž™...</p>
        </div>
      </div>
    );
  }
      ...
      <Table
        ...
        rows={movies.map((m) => [
          ...
          <span className="flex items-center gap-1" key={`year-${m.id}`}>
            ...
            {new Date(m.release_date).getFullYear() || "â€”"}
          </span>,
          ...
          <div className="flex items-center gap-1.5" key={`act-${m.id}`}>
            <button
              ...
              title="áž˜áž¾áž›áž›áž˜áŸ’áž¢áž·áž"
