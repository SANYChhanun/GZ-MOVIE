// src/pages/admin/NotificationManagementPage.jsx â€” broadcast messages to audience segments.
...
export default function NotificationManagementPage() {
  ...
  const send = (e) => {
    ...
    setNotifs((prev) => [{ id: Date.now(), title, audience, sent: "Just now", reach: "â€”" }, ...prev]);
    setTitle("");
  };
