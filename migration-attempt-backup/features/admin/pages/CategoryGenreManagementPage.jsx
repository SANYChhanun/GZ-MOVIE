...
export default function CategoryGenreManagementPage() {
  ...
  const tabs = [
    { id: 'genres', label: 'áž”áŸ’ážšáž—áŸáž‘ážšáž¿áž„', icon: Tag },
    { id: 'series_types', label: 'áž”áŸ’ážšáž—áŸáž‘ážšáž¿áž„áž—áž¶áž‚', icon: Tv },
    { id: 'countries', label: 'áž”áŸ’ážšáž‘áŸážŸ', icon: Globe },
    { id: 'categories', label: 'áž€áŸ’ážšáž»áž˜áž•áŸ’ážŸáŸáž„áŸ—', icon: Folder },
  ];
  ...
  const fetchItems = async () => {
    ...
    try {
      ...
      // áž”áŸ’ážšáž¾ switch ážŠáž¾áž˜áŸ’áž”áž¸áž„áž¶áž™ážŸáŸ’ážšáž½áž›áž€áŸ’áž“áž»áž„áž€áž¶ážšáž‚áŸ’ážšáž”áŸ‹áž‚áŸ’ážšáž„ tabs áž…áŸ’ážšáž¾áž“
      switch (activeTab) {
        case 'genres':
      ...
      setError(`áž˜áž·áž“áž¢áž¶áž…áž‘áž¶áž‰áž™áž€áž‘áž·áž“áŸ’áž“áž“áŸáž™ ${activeTab} áž”áž¶áž“áž‘áŸ`);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name.trim()) {
      alert('ážŸáž¼áž˜áž”áž‰áŸ’áž…áž¼áž›ážˆáŸ’áž˜áŸ„áŸ‡');
      return;
    }
    ...
    try {
      const data = {
        ...
        // áž”áž“áŸ’ážáŸ‚áž˜ flag ážŸáž˜áŸ’ážšáž¶áž”áŸ‹ countries áž“áž·áž„ series_types
      ...
      alert('ážšáž€áŸ’ážŸáž¶áž‘áž»áž€áž˜áž·áž“áž”áž¶áž“ážŸáž˜áŸ’ážšáŸáž…áŸ” ážŸáž¼áž˜áž–áŸ’áž™áž¶áž™áž¶áž˜áž˜áŸ’ážáž„áž‘áŸ€ážáŸ”');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      alert('áž›áž»áž”áž˜áž·áž“áž”áž¶áž“ážŸáž˜áŸ’ážšáŸáž…áŸ” ážŸáž¼áž˜áž–áŸ’áž™áž¶áž™áž¶áž˜áž˜áŸ’ážáž„áž‘áŸ€ážáŸ”');
    }
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white">áž‚áŸ’ážšáž”áŸ‹áž‚áŸ’ážšáž„áž”áŸ’ážšáž—áŸáž‘ áž“áž·áž„áž”áŸ’ážšáž‘áŸážŸ</h1>
          <p className="text-gray-400 text-sm mt-1">
            áž”áž“áŸ’ážáŸ‚áž˜ áž€áŸ‚áž”áŸ’ážšáŸ‚ áž¬áž›áž»áž”áž”áŸ’ážšáž—áŸáž‘ážšáž¿áž„ áž”áŸ’ážšáž—áŸáž‘ážšáž¿áž„áž—áž¶áž‚ áž”áŸ’ážšáž‘áŸážŸ áž“áž·áž„áž€áŸ’ážšáž»áž˜áž•áŸ’ážŸáŸáž„áŸ—
          </p>
        </div>
        <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  {/* áž”áž„áŸ’áž áž¶áž‰ flag ážŸáž˜áŸ’ážšáž¶áž”áŸ‹ countries áž“áž·áž„ series_types */}
          ...
          {filteredItems.length === 0 && (
            <div className="col-span-full flex flex-col items-center justify-center py-16 text-center">
              <p className="text-gray-500">áž˜áž·áž“áž˜áž¶áž“áž‘áž·áž“áŸ’áž“áž“áŸáž™áž‘áŸ</p>
              <button
                onClick={openCreateModal}
                className="mt-3 inline-flex items-center gap-1.5 text-amber-400 hover:text-amber-300"
              >
                <Plus size={14} /> áž”áž“áŸ’ážáŸ‚áž˜ážáŸ’áž˜áž¸
              </button>
            </div>
          )}
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="bg-slate-900 border border-slate-800 rounded-xl w-full max-w-md p-6 relative">
            ...
            <h2 className="text-lg font-semibold text-slate-100 mb-4">
              {editingItem ? 'áž€áŸ‚áž”áŸ’ážšáŸ‚' : 'áž”áž“áŸ’ážáŸ‚áž˜ážáŸ’áž˜áž¸'}
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder={
                    activeTab === 'genres' ? 'áž§áž‘áž¶áž ážšážŽáŸáŸ– Action, Drama' :
                    activeTab === 'series_types' ? 'áž§áž‘áž¶áž ážšážŽáŸáŸ– ážšáž¿áž„áž—áž¶áž‚áž…áž·áž“' :
                    activeTab === 'countries' ? 'áž§áž‘áž¶áž ážšážŽáŸáŸ– ážáŸ’áž˜áŸ‚ážš, áž…áž·áž“' :
                    'áž§áž‘áž¶áž ážšážŽáŸáŸ– áž“áž·áž™áž¶áž™ážáŸ’áž˜áŸ‚ážš'
                  }
                />
              </div>

              {/* áž”áž„áŸ’áž áž¶áž‰ flag field ážŸáž˜áŸ’ážšáž¶áž”áŸ‹ countries áž“áž·áž„ series_types */}
              {(activeTab === 'countries' || activeTab === 'series_types') && (
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-1">
                    {activeTab === 'countries' ? 'áž‘áž„áŸ‹áž‡áž¶ážáž· (Emoji)' : 'áž“áž·áž˜áž·ážáŸ’ážážŸáž‰áŸ’áž‰áž¶ (Emoji)'}
                  </label>
                  <input
                    type="text"
                    value={formData.flag || ''}
                    ...
                    className={`${inputClass} w-full`}
                    placeholder={activeTab === 'countries' ? 'ðŸ‡°ðŸ‡­ ðŸ‡¨ðŸ‡³ ðŸ‡°ðŸ‡·' : 'ðŸ‡¨ðŸ‡³ ðŸ‡ºðŸ‡¸ ðŸ‡°ðŸ‡·'}
                  />
                </div>
              )}
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                >
                  ...
                  {editingItem ? 'ážšáž€áŸ’ážŸáž¶áž‘áž»áž€' : 'áž”áž“áŸ’ážáŸ‚áž˜'}
                </button>
              </div>
            </form>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="bg-slate-900 border border-red-500/30 rounded-xl w-full max-w-md p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-lg font-semibold text-white">áž”áž‰áŸ’áž‡áž¶áž€áŸ‹áž€áž¶ážšáž›áž»áž”</h2>
                <p className="text-sm text-gray-400">ážŸáž€áž˜áŸ’áž˜áž—áž¶áž–áž“áŸáŸ‡áž˜áž·áž“áž¢áž¶áž…ážáŸ’ážšáž¡áž”áŸ‹ážœáž·áž‰áž”áž¶áž“áž‘áŸ</p>
              </div>
            </div>

            <div className="bg-slate-800/50 rounded-lg p-4 mb-4">
              <p className="text-sm text-gray-300">
                ážáž¾áž¢áŸ’áž“áž€áž”áŸ’ážšáž¶áž€ážŠážáž¶áž…áž„áŸ‹áž›áž»áž”{' '}
                <span className="font-bold text-white">{deleteConfirm.name}</span> áž˜áŸ‚áž“áž‘áŸ?
              </p>
            </div>
