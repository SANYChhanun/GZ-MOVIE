// src/pages/admin/BannerFeaturedContentPage.jsx â€” hero & promo strip banners.
...
export default function BannerFeaturedContentPage() {
  ...
  // Submit (create or update) â€” sends multipart/form-data so the image file reaches Django's ImageField
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl w-full max-w-lg p-6 relative max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {imagePreview ? (
                    <div className="relative aspect-video">
                      ...
                      {imageFile && (
                        <button
                          ...
                          title="Undo â€” keep current image"
                    ...
                    <label className="flex flex-col items-center justify-center gap-1.5 aspect-video px-4 text-center cursor-pointer">
                      ...
                      <span className="text-xs text-slate-600">
                        PNG or JPG, up to 5MB Â· Recommended 1600Ã—900
                      </span>
                      <input
                        type="file"
                        accept="image/*"
              ...
              {/* Link target: this drives what clicking the banner actually does.
                  "Movie" is the normal case â€” the banner always resolves to the
              ...
              <div>
                ...
                {form.link_type === "movie" && (
                  <div>
                    ...
                    >
                      <option value="">
                        {moviesLoading ? "Loading moviesâ€¦" : "Select a movieâ€¦"}
                      </option>
                      {movies.map((m) => (
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                      The banner will link to this movie's page (/watch/{form.movie || "â€¦"}).
                    </p>
                  </div>
                )}
