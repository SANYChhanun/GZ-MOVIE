// src/pages/watch/VideoPlayerPage.jsx â€” Full Code with Bootstrap Icons
...
useEffect(() => {
  const fetchMovie = async () => {
    ...
    try {
      ...
      console.log('ðŸ“¹ video_file:', data.video_file);
      console.log('ðŸ†” bunny_video_id:', data.bunny_video_id);
      console.log('ðŸ“º video_embed_url:', data.video_embed_url);

      // âœ… áž–áž·áž“áž·ážáŸ’áž™áž”áŸ’ážšáž—áž–ážœáž¸ážŠáŸáž¢áž¼ážáž¶áž˜áž›áŸ†ážŠáž¶áž”áŸ‹
      ...
      // âœ… áž”áž“áŸ’ážáŸ‚áž˜ autoplay áž“áž·áž„ disableCast
      ...
      if (!videoUrl) {
        console.warn('âš ï¸ No video found for movie:', data);
      }
    } catch (err) {
      console.error('Failed to fetch movie:', err);
      setError('áž˜áž·áž“áž¢áž¶áž…áž‘áž¶áž‰áž™áž€áž‘áž·áž“áŸ’áž“áž“áŸáž™ážšáž¿áž„áž”áž¶áž“áž‘áŸáŸ”');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <Link to={`/movies/${id}`} className="text-red-500 hover:underline mt-4 inline-block">
            ...
            ážáŸ’ážšáž¡áž”áŸ‹áž‘áŸ…áž‘áŸ†áž–áŸážšážšáž¿áž„
          </Link>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-black font-khmer">
        ...
        <div className="flex items-center justify-center h-screen text-white">
          <div className="text-center">
            ...
            <p className="text-lg">áž˜áž·áž“áž˜áž¶áž“ážœáž¸ážŠáŸáž¢áž¼ážŸáž˜áŸ’ážšáž¶áž”áŸ‹áž—áž¶áž–áž™áž“áŸ’ážáž“áŸáŸ‡áž‘áŸ</p>
            <p className="text-gray-500 text-sm mt-2">ážŸáž¼áž˜áž–áž·áž“áž·ážáŸ’áž™áž˜áŸ’ážáž„áž‘áŸ€ážáž“áŸ…áž–áŸáž›áž€áŸ’ážšáŸ„áž™</p>
    ...
    <div className="min-h-screen bg-black font-khmer relative">
      ...
      <div className={`absolute top-4 right-4 z-30 flex items-center gap-3 transition-opacity duration-500 ${showControls ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <button
          ...
          title={isFullscreen ? 'áž…áŸáž‰áž–áž¸ Fullscreen (F)' : 'Fullscreen (F)'}
        >
      ...
      {isDirectVideo ? (
        ...
        >
          <p>áž€áž˜áŸ’áž˜ážœáž·áž’áž¸ážšáž»áž€ážšáž€ážšáž”ážŸáŸ‹áž¢áŸ’áž“áž€áž˜áž·áž“áž‚áž¶áŸ†áž‘áŸ’ážšáž€áž¶ážšáž…áž¶áž€áŸ‹ážœáž¸ážŠáŸáž¢áž¼áž‘áŸáŸ”</p>
        </video>
      ) : (
