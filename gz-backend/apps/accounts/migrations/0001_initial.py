    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration_days', models.IntegerField(choices=[(7, 'Weekly'), (30, 'Monthly'), (90, 'Quarterly'), (365, 'Yearly')], default=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type', models.CharField(choices=[('web', 'Web Browser'), ('android', 'Android'), ('ios', 'iOS'), ('smart_tv', 'Smart TV'), ('other', 'Other')], default='web', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[('phone_verify', 'Phone Verification'), ('email_verify', 'Email Verification'), ('password_reset', 'Password Reset')], max_length=20)),
                ('expires_at', models.DateTimeField(default=django.utils.timezone.now)),
